namespace SqlSchemaComparer.Forms
{
    partial class FormOptions
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chkSortOnDependancies = new System.Windows.Forms.CheckBox();
			...
			this.butSave.Location = new System.Drawing.Point(44, 163);
			...
			this.butCancel.Location = new System.Drawing.Point(131, 163);
			...
			// 
			// chkSortOnDependancies
			// 
			this.chkSortOnDependancies.AutoSize = true;
			this.chkSortOnDependancies.Location = new System.Drawing.Point(185, 123);
			this.chkSortOnDependancies.Name = "chkSortOnDependancies";
			this.chkSortOnDependancies.Size = new System.Drawing.Size(15, 14);
			this.chkSortOnDependancies.TabIndex = 18;
			this.chkSortOnDependancies.UseVisualStyleBackColor = true;
			// 
			// label6
			// 
			...
			this.label6.Text = "Sort objects on dependancies?";
			// 
			// FormOptions
			// 
			...
			this.Controls.Add(this.chkSortOnDependancies);
		...
		private System.Windows.Forms.CheckBox chkSortOnDependancies;
