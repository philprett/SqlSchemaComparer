namespace SqlSchemaComparer.Forms
{
    partial class FormDatabase
    {
        ...
        private void InitializeComponent()
        {
			...
			this.chkAllowChanges = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// butCancel
			// 
			...
			this.butCancel.Location = new System.Drawing.Point(233, 247);
			...
			this.butSave.Location = new System.Drawing.Point(154, 247);
			...
			// chkAllowChanges
			// 
			this.chkAllowChanges.AutoSize = true;
			this.chkAllowChanges.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.chkAllowChanges.Location = new System.Drawing.Point(12, 216);
			this.chkAllowChanges.Name = "chkAllowChanges";
			this.chkAllowChanges.Size = new System.Drawing.Size(114, 17);
			this.chkAllowChanges.TabIndex = 21;
			this.chkAllowChanges.Text = "Changes Allowed?";
			this.chkAllowChanges.UseVisualStyleBackColor = true;
			// 
			// FormDatabase
			// 
			...
			this.Controls.Add(this.chkAllowChanges);
		...
		private System.Windows.Forms.CheckBox chkAllowChanges;
	}
}