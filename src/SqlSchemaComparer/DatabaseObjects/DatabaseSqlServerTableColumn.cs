...
namespace SqlSchemaComparer.DatabaseObjects
{
    internal class DatabaseSqlServerTableColumn
    {
        ...
        public string GetDefinitionType()
        {
            ...
            else if (ColumnType == "varbinary" || ColumnType == "varchar" || ColumnType == "binary" || ColumnType == "char" || ColumnType == "nvarchar" || ColumnType == "nchar")
            {
        ...
        public static List<DatabaseSqlServerTableColumn> GetFromDataTable(DataTable columns, DataTable pks, DataTable indexes)
        {
            // columns
            ...
            foreach (DataRow row in columns.Rows)
            {
                ...
                {
                    if ((string)index["tablename"] == newColumn.ObjectName &&
                        (string)index["ColumnName"] == newColumn.ColumnName)
                    {
                        newColumn.IndexName = (string)index["IndexName"];
                        break;
                    }
                }
